...
Collect the Stars
1) Drag a line from one star to another to connect them, or alternatively click on one, and then the other.
2) Right click on a connection to delete it.
3) Click help in the main menu to view what the different colors of stars mean.
4) Once you have made all of the correct connections, a picture of the constellation will be shown and you will move on to the next level.

There are no cheat codes, but if you do genuinely get stuck on a level, these are the solutions:
...
else if (level == 6) //libra room
{
    var solution; solution[5] = 0; //allocate an array
    solution[0] = "1-2";
    solution[1] = "2-3";
    solution[2] = "2-4";
    solution[3] = "3-4";
...
else if (level == 9) //capricorn room
{
...
else if (level == 12) //virgo room
{
    var solution; solution[11] = 0; //allocate an array
    solution[0] = "1-2";
    solution[1] = "2-3";
    solution[2] = "3-4";
    solution[3] = "4-5";
...
{
    var solution; solution[12] = 0; //allocate an array
    solution[0] = "1-2";
    solution[1] = "2-3";
    solution[2] = "3-4";
    solution[3] = "4-5";
